...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    'tk': {
      ...
      'termsTitle': 'Ulanyş şertleri',
      'termsLoadError': 'Şertnamany ýüklemek başartmady.',
      'termsEmpty': 'Şertnama maglumaty elýeterli däl.',
      ...
      'realtimeJobAssignedGeneric': 'Size täze sargyt bellendi',
      'realtimeJobAssignedNamed': 'Täze sargyt: {client}',
      'realtimeJobAssignedOrder': 'Täze sargyt #{id}',
    ...
    'ru': {
      ...
      'termsLoadError': 'Не удалось загрузить условия.',
      'termsEmpty': 'Текст условий недоступен.',
      ...
      'realtimeJobAssignedGeneric': 'Вам назначена новая заявка',
      'realtimeJobAssignedNamed': 'Новая заявка: {client}',
      'realtimeJobAssignedOrder': 'Новая заявка #{id}',
